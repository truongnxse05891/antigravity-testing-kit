...
- **BẮT BUỘC:** Tất cả các file test case (.md, .csv) sinh ra **PHẢI** được lưu vào thư mục `test_cases/`.
...
3. Xuất dưới dạng Artifact nếu dài và lưu trực tiếp vào thư mục `test_cases/`.

## Output

- Bảng Test Cases Markdown hoàn chỉnh, sẵn sàng copy sang Excel/TestRail
- Traceability Matrix
